...
/***/ function(module, exports, __webpack_require__) {
	...
	var SlugInput = __webpack_require__(2);

	var test = function(event){
		console.log(event.target)
	}
	React.render(React.createElement(SlugInput, {onChange: test}), document.body)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SlugInput = React.createClass({displayName: "SlugInput",
	  propTypes: {
	  ...
	  render: function(){
	    return React.createElement("input", React.__spread({},  this.getComputedProps()))
	  }
	})
